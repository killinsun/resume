...
- カスタマーサクセス
	- 営業と商談に同行して技術質問に回答したり、導入前に見つかった課題を解決するための提案（「A だとうまくいかないが、B であれば運用に乗せられると思う」といった提案）。
...
-  実績
	...
	- ジュニアエンジニア 1 名の教育
	- 開発プロセスの構築
		- スクラムに馴染みのない Biz メンバーを交えてプロダクトを作るため、スクラム用語を使わずに少しずつスクラムの要素を取り入れていった
	- 2025 年現在、エンジニア採用中
...
- 実績
	- 2023 年 3 月に ChatGPT の API が提供された 1 週間後に PoC を個人で開発し切る。2 か月後には[日経新聞でプレスリリース](https://www.nikkei.com/article/DGXZQOUC09C3A0Z00C23A5000000/)。名実共にシニアエンジニアとしての自信を得たイベントだった。これがきっかけで CEO に声をかけられ、新規事業を立ち上げることになった。
